...
Bringing as many processes to ready queue **([[2. Types of Operating System#Multi Programmed OS |MultiProgramming]])**

^6dace5

> [!NOTE] Short Term Scheduler : 
Bring Processes after execution and deallocation of current Process **([[2. Types of Operating System#Multi Tasking / Time Sharing OS | Multi Tasking]])**
